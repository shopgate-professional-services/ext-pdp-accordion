...
import AverageRating from './components/AverageRating/index';
import WriteReviewLink from './components/WriteReviewLink/index';
...
const Header = ({ rating, withTopGap }) => {
  ...
  return (
    <div className={`${containerClass} reviewsExcerpt`}>
      <AverageRating rating={rating} />
